...
public class BinarySearchTree < T extends Comparable < ? super T >>
{
    ...
    private boolean isBalanced( BinaryNode<T> binaryNode ) {
    	
    	return ( root.equals(null) || isBalanced( root.getLeftChild() ) && isBalanced( root.getRightChild() )
    			&& Math.abs(root.getLeftChild().getHeight() - root.getRightChild().getHeight()) <= 1 ); 
   
    } //end private method isBalanced
    ...
    public static boolean isBST( BinaryTree<String> tree ) { // ?
        ...
        else if ( tree.root.hasLeftChild() && tree.root.hasRightChild() ) {
            return true;
        }
